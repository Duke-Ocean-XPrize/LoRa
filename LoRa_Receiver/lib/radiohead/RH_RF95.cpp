...
bool RH_RF95::init()
{
    ...
    if (interruptNumber == NOT_AN_INTERRUPT){
        printf("Error: The interupt pin is a lie");
        return false;
    }
#endif
    ...
    {
    printf("Error: I was writting ");
    printf("%02x",(RH_RF95_MODE_SLEEP | RH_RF95_LONG_RANGE_MODE));
    printf(" But read back");
	printf("%02x",spiRead(RH_RF95_REG_01_OP_MODE));
    printf("\nNo Device Present? \n");
    ...
    setModemConfig(Bw125Cr48Sf4096); // Radio default
